...
.. dropdown:: Getting started
    ...
    - :doc:`Create a managed Aiven for PostgreSQL® service </docs/platform/howto/create_new_service>`
    - :doc:`Connect to Aiven for PostgreSQL® </docs/products/postgresql/howto/list-code-samples>`
    - :doc:`Load sample data into Aiven for PostgreSQL® </docs/products/postgresql/howto/pagila>`

.. dropdown:: Connect to your service
...
.. dropdown:: Cluster management
    ...
    - :doc:`Monitor a managed Aiven for PostgreSQL® service </docs/platform/howto/monitoring-services>`
    - :doc:`Resize a managed Aiven for PostgreSQL® service </docs/platform/howto/scale-services>`
    - :doc:`Schedule automatic maintenance updates </docs/platform/howto/prepare-for-high-load>`
    - :doc:`Upgrade a managed Aiven for PostgreSQL® service </docs/platform/howto/scale-services>`
    - :doc:`Tag a managed Aiven for PostgreSQL® service </docs/platform/howto/tag-resources>`
    - :doc:`Power-off and delete a managed Aiven for PostgreSQL® service </docs/platform/howto/pause-from-cli>`
    - :doc:`Migrate a managed Aiven for PostgreSQL® service </docs/platform/howto/migrate-services-cloud-region>`
    - :doc:`Fork a managed Aiven for PostgreSQL® service </docs/platform/howto/console-fork-service>`
